...
---------------------
    ...
    cd src/
    make -f makefile.unix		# Headless crypto

See readme-qt.rst for instructions on building Crypto-Qt, the graphical user interface.
...
To compile Crypto with GNU make:
...
Security
--------
To help make your crypto installation more secure by making certain attacks impossible to
